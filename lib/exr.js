export function createEXR(width, height, channels, rgba) {
  let pSize = 2, pType = 1; // 2=float32, 1=float16, 0=int32
  ...
  stream.write([
    ...
    { str: ['channels', 'chlist'] },
    { i32: [18 * channels + 1] },
    { str: ['B'] }, { i32: [pType, 1, 1, 1] }, // pixel type, Plinear, X sampling, Y sampling
    { str: ['G'] }, { i32: [pType, 1, 1, 1] },
    { str: ['R'] }, { i32: [pType, 1, 1, 1] },
    { buf: [0] },
